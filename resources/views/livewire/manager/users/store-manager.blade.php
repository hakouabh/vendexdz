        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100 text-sm">
                    ...
                    <tr wire:key="store-{{ $store->id }}" class="hover:bg-gray-50/80 transition duration-150 group">
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 font-semibold text-slate-900">
                            <a href="{{ route('impersonate', $store->id) }}" class="text-xs font-medium text-indigo-500 hover:text-indigo-700 hover:underline transition"><i class="las la-sign-in-alt"></i>@lang('Login as') {{$store->name}}</a>
                        </td>
                        <td class="px-6 py-4">
                            @if($store->is_active)
                            <span
                        ...
                        <td class="px-6 py-4 text-right">
                            <button wire:click="openEditModal({{ $store->id }})" wire:loading.attr="disabled"
            ...
            <div class="px-2 pt-2 flex items-start justify-between">
                <div class="flex gap-4">
                    <div
                        ...
                        <i class="ri-store-3-line text-2xl text-indigo-600"></i>
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                            <i
                                class="ri-building-4-line text-slate-400 group-focus-within:text-indigo-500 transition-colors"></i>
                        </div>
                        <input type="text" wire:model="name"
                            ...
                            placeholder="e.g. Vendex Mega Store">
                    </div>
