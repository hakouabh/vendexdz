  <div>
      ...
      <div class="">
          ...
          <div wire:loading.remove>
              ...
              @livewire('agent.order.inconfermation-manager')

              @elseif ($currentTab === 'postponed')
              @livewire('agent.order.reported-manager')

              @elseif ($currentTab === 'waiting')
              @livewire('agent.order.pending-manager')

              @elseif ($currentTab === 'indelivery')
              @livewire('agent.order.indelivery-manager')
              @endif
          </div>
