            ...
            <div class="border-t border-gray-100 bg-gray-50/50">
                ...
                <div
                    ...
                    <div class="flex flex-wrap gap-3">
                        <button wire:click="RemoveNow"
                            class="flex items-center gap-2 rounded-lg bg-red-600 px-6 py-2 text-xs font-bold text-white shadow-md shadow-red-100 transition-all hover:bg-red-700 hover:shadow-lg hover:-translate-y-0.5">
                            <i class="ri-delete-bin-line text-sm"></i>
                            @lang('Remove Delivery')
                        </button>
                        <button wire:click="shipNow" wire:loading.attr="disabled"
