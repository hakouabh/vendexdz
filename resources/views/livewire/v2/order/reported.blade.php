    ...
    <div class="flex flex-col lg:flex-row lg:justify-between w-full font-bold gap-3">
        ...
        <div class="flex flex-wrap gap-2 w-full lg:w-3/5">
            ...
            <x-dropdown align="left" width="48">
                <x-slot name="trigger">
                    <button type="button"
                        class="inline-flex items-center px-3 py-2 border border-gray-300 text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 transition">
