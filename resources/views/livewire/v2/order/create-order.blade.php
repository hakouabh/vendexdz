<div class="w-full space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route($context.'.orders') }}" 
            class="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-gray-100 text-gray-700 hover:bg-gray-200 transition-all">
            <i class="ri-arrow-left-line"></i>
            <span class="text-[11px] font-bold">@lang('Back to Orders')</span>
        </a>
    </div>
            ...
            <div class="p-6">
                <div class="space-y-2">
                    ...
                    <div class="flex justify-between text-sm">
                        ...
                        <span class="font-bold text-red-600">-{{ $discount }} DZD</span>
                    </div>
