<div>
    <div class="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
        ...
        <div class="p-6 border-b border-gray-100 flex justify-between items-center">
            <div>
                <h2 class="text-lg font-bold text-slate-900">Pendings</h2>
                <p class="text-sm text-slate-500 mt-1">Manage your Pendings.</p>
            </div>
    ...
    <x-dialog-modal wire:model="isEditModalOpen" maxWidth="lg">
            ...
            <div class="px-2 pt-2 flex items-start justify-between">
                <div class="flex gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500 mt-1">Manage Pending details, contact info, and visibility.</p>
                    </div>
                </div>
        ...
        <x-slot name="content">
            <div class="space-y-6 px-2">
                <div>
                    <label class="text-[11px] uppercase tracking-wider font-bold text-slate-500 mb-1.5 block">Pending
                        Information</label>
                        ...
                        <div class="flex-1">
                            <div class="flex items-center gap-2 mb-1">
                                <span class="text-sm font-bold {{ $is_active ? 'text-indigo-700' : 'text-slate-700' }}">
                                    {{ $is_active ? 'Active Pending' : 'Inactive Pending' }}
                                </span>
                                @if($is_active)
                                <span
                            ...
                            <p class="text-xs {{ $is_active ? 'text-indigo-600/80' : 'text-slate-500' }}">
                                {{ $is_active ? 'This Pending is currently visible to all users and accepting orders.' : 'This Pending is hidden from the public and cannot accept orders.' }}
                            </p>
                        </div>
