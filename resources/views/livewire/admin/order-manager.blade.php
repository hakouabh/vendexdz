  <div>
      ...
      <div class="">
          ...
          <div wire:loading.remove>
              ...
              @livewire('admin.order.inconfermation-manager')

              @elseif ($currentTab === 'postponed')
              @livewire('admin.order.reported-manager')

              @elseif ($currentTab === 'waiting')
              @livewire('admin.order.pending-manager')

              @elseif ($currentTab === 'indelivery')
              @livewire('admin.order.indelivery-manager')
              @endif
          </div>
