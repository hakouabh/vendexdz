  <div>
      <div class="mb-8">
          <h1 class="text-2xl font-bold text-slate-900">@lang('Linking')</h1>
          <p class="text-slate-500 mt-1 flex items-center gap-2">
              <span class="text-sm font-normal text-slate-400">@lang('You Can Link Client,Agent and Manager  Here')</span>
          </p>
      </div>
      <div class="">
          <div class="mb-8">
