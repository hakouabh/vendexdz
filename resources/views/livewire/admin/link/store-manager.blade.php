    ...
    <div class="flex flex-col lg:flex-row gap-6 items-start">
            ...
            <div class="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
                ...
                <div class="p-6 border-b border-gray-100 flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-sm text-slate-500 mt-1">Manage your active Stores.</p>
                    </div>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-xs text-slate-400">whatsapp : {{$store->phone}}</div>
                                        </div>
                                    </div>
                                </td>
                ...
                <div class="px-6 py-4 border-t border-gray-100">
                    <span class="text-sm text-slate-500">Showing <span class="font-medium text-slate-900">1-5</span> of
                        50</span>
                </div>
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/3">
            ...
            <div class="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
                ...
                <div class="p-6 border-b border-gray-100 flex justify-between items-center">
                    <div>
                        <h2 class="text-lg font-bold text-slate-900">Product</h2>
                        <p class="text-sm text-slate-500 mt-1">All {{'StoreName'}}</p>
                    </div>
                    <div class="relative w-44 group hidden md:block">
                        <i class="ri-search-line absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"></i>
                        <input type="text" placeholder="Search..."
                            class="w-full pl-10 pr-3 py-2 bg-gray-50 border border-transparent focus:bg-white focus:border-indigo-200 focus:ring-2 focus:ring-indigo-50 rounded-lg outline-none text-sm transition text-slate-700 placeholder-gray-400">
                    </div>
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-100 text-sm">
                            ...
                            <tr class="hover:bg-gray-50/80 transition duration-150 group">
                                ...
                                <td class="px-6 py-4">
                                    @if($store->is_active)
                                     <div class="font-medium text-slate-900">450</div>
                                    @endif
                                </td>
