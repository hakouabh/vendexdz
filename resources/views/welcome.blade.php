...
<body class="bg-gray-50 scroll-smooth custom-scrollbar">
    ...
    <header class="fixed top-0 w-full z-50 glass-effect transition-all duration-300" id="header">
        <nav class="container mx-auto px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="#features" class="text-gray-700 hover:text-purple-600 transition-colors">@lang('Features')</a>
                    <a href="#tracking" class="text-gray-700 hover:text-purple-600 transition-colors">@lang('Tracking')</a>
                    <a href="#testimonials"
                        class="text-gray-700 hover:text-purple-600 transition-colors">@lang('Testimonials')</a>
                    <a href="#contact" class="text-gray-700 hover:text-purple-600 transition-colors">@lang('Contact')</a>
        ...
        <!-- Mobile Menu -->
        <div id="mobile-menu"
            class="hidden md:hidden bg-white/95 backdrop-blur-lg border-t border-gray-200 shadow-lg">

            <div class="px-6 py-4 space-y-4">

                <a href="#features" class="block text-gray-700 hover:text-purple-600">
                    @lang('Features')
                </a>

                <a href="#tracking" class="block text-gray-700 hover:text-purple-600">
                    @lang('Tracking')
                </a>

                <a href="#testimonials" class="block text-gray-700 hover:text-purple-600">
                    @lang('Testimonials')
                </a>

                <a href="#contact" class="block text-gray-700 hover:text-purple-600">
                    @lang('Contact')
                </a>
                ...
                <div class="border-t pt-4">
                    ...
                    @if(auth()->user()->roles()->where('roles.rid', 2)->exists())
                    <a href="/admin/dashboard"
                        class="block px-4 py-2 bg-gray-900 text-white rounded-lg text-center">
                        @lang('Admin dashboard')
                    </a>
                    ...
                    <a href="/login"
                        class="block px-4 py-2 text-gray-700 hover:text-green-700">
                        @lang('Sign In')
                    </a>
