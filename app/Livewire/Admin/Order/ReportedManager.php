...
class ReportedManager extends Component
{
    ...
    ->get();
        ...
        return view('livewire.admin.order.reported-manager', ['orders' => $orders,'wilayas'=>$willayas, 'firstStepStatus'=>$firstStepStatus ,'products'=>$products,'stores'=>$stores]);
    }
