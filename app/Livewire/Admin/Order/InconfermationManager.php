...
class InconfermationManager extends Component
{
    ...
    ->get();
        ...
        return view('livewire.admin.order.inconfermation-manager', ['orders' => $orders,'wilayas'=>$willayas, 'firstStepStatus'=>$firstStepStatus ,'products'=>$products,'stores'=>$stores]);
    }
